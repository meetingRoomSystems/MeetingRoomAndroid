...
/**
 * This class is a custom spinner which shows a dialog with options and the user can select more than one of these options.
 * Used to show all the names for colleagues to tag in a meeting
 */
